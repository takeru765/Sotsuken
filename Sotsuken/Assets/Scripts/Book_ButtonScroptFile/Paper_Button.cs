...
public class Paper_Button : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Btrash_paper = TrashPoint.paper;//引用した数値を入れる変数

        if (Btrash_paper == 5)//仮の数値。登録したごみが１個以上になった場合に、図鑑の項目が出現するようになる。
        {
